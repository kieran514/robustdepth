...
train_detect = \
    ['scene-0001', 'scene-0002', 'scene-0041', 'scene-0042', 'scene-0043', 'scene-0044', 'scene-0045', 'scene-0046',
     ...
     'scene-0055', 'scene-0056', 'scene-0057', 'scene-0112', 'scene-0059', 'scene-0060', 'scene-0061', 'scene-0062',
     'scene-0063', 'scene-0064', 'scene-0065', 'scene-0066', 'scene-0067', 'scene-0068', 'scene-0069', 'scene-0070',
     'scene-0071', 'scene-0114', 'scene-0073', 'scene-0074', 'scene-0075', 'scene-0076', 'scene-0161', 'scene-0162',
     ...
     'scene-0084', 'scene-0741', 'scene-0744', 'scene-0746', 'scene-0101', 'scene-0749', 'scene-0750', 'scene-0751',
     ...
     'scene-0898', 'scene-0102', 'scene-0900', 'scene-0901', 'scene-0902', 'scene-0903', 'scene-0945', 'scene-0947',
     ...
     'scene-0981', 'scene-0982', 'scene-0983', 'scene-0984', 'scene-0017', 'scene-0989', 'scene-0990', 'scene-0991',
     ...
     'scene-1075', 'scene-1076', 'scene-1077', 'scene-1078', 'scene-1079', 'scene-0110', 'scene-1081', 'scene-1082',
     ...
     'scene-1099', 'scene-1100', 'scene-1101', 'scene-1102', 'scene-0099', 'scene-1105']

train_track = \
    ['scene-0004', 'scene-0005', 'scene-0006', 'scene-0007', 'scene-0008', 'scene-0009', 'scene-0010', 'scene-0147',
     'scene-0019', 'scene-0020', 'scene-0021', 'scene-0113', 'scene-0023', 'scene-0024', 'scene-0025', 'scene-0026',
     'scene-0094', 'scene-0028', 'scene-0029', 'scene-0030', 'scene-0031', 'scene-0032', 'scene-0033', 'scene-0034',
     ...
     'scene-0138', 'scene-0139', 'scene-0149', 'scene-0150', 'scene-0096', 'scene-0152', 'scene-0154', 'scene-0155',
     ...
     'scene-0219', 'scene-0220', 'scene-0222', 'scene-0224', 'scene-0082', 'scene-0226', 'scene-0227', 'scene-0228',
     'scene-0229', 'scene-0230', 'scene-0231', 'scene-0232', 'scene-0233', 'scene-0234', 'scene-0235', 'scene-0236',
     'scene-0237', 'scene-0238', 'scene-0239', 'scene-0280', 'scene-0241', 'scene-0242', 'scene-0243', 'scene-0244',
     ...
     'scene-0392', 'scene-0393', 'scene-0394', 'scene-0395', 'scene-0396', 'scene-0397', 'scene-0143', 'scene-0399',
     'scene-0018', 'scene-0401', 'scene-0402', 'scene-0403', 'scene-0405', 'scene-0406', 'scene-0407', 'scene-0408',
     ...
     'scene-0446', 'scene-0447', 'scene-0077', 'scene-0449', 'scene-0450', 'scene-0451', 'scene-0452', 'scene-0453',
     ...
     'scene-0528', 'scene-0529', 'scene-0530', 'scene-0531', 'scene-0532', 'scene-0533', 'scene-0534', 'scene-0117',
     ...
     'scene-0644', 'scene-0645', 'scene-0646', 'scene-0647', 'scene-0648', 'scene-0649', 'scene-0650', 'scene-0015',
     ...
     'scene-0698', 'scene-0700', 'scene-0701', 'scene-0703', 'scene-0704', 'scene-0140', 'scene-0706', 'scene-0707',
     ...
     'scene-0849', 'scene-0105', 'scene-0851', 'scene-0852', 'scene-0853', 'scene-0854', 'scene-0855', 'scene-0856',
     ...
     'scene-1058', 'scene-1106', 'scene-1107', 'scene-0013', 'scene-1109', 'scene-1110', 
     'scene-0276', 'scene-0277', 'scene-0278', 'scene-0329', 'scene-0330', 'scene-0331', 'scene-0332', 'scene-0344',
     'scene-0345', 'scene-0346', 'scene-0519', 'scene-0520', 'scene-0521', 'scene-0522', 'scene-0523', 'scene-0524',
     'scene-0308', 'scene-0553', 'scene-0554', 'scene-0555', 'scene-0556', 'scene-0557', 'scene-0558', 'scene-0559',
     ...
     'scene-0916', 'scene-0917', 'scene-0281', 'scene-0920', 'scene-0921', 'scene-0922', 'scene-0036', 'scene-0924',
     'scene-0925', 'scene-0926', 'scene-0927', 'scene-0928', 'scene-0929', 'scene-0930', 'scene-0931', 'scene-0962',
     'scene-0963', 'scene-0966', 'scene-0967', 'scene-0968', 'scene-0969', 'scene-0971', 'scene-0972', 'scene-1059',
     'scene-1060', 'scene-1061', 'scene-1062', 'scene-1063', 'scene-1064', 'scene-1065', 'scene-1066', 'scene-0106',
     'scene-1068', 'scene-1069', 'scene-1070', 'scene-1071', 'scene-1072', 'scene-1073', 'scene-0268', 'scene-0269', 
     'scene-0270', 'scene-0271', 'scene-0272', 'scene-0273', 'scene-0274', 'scene-0275',
     ...
     'scene-0940', 'scene-0941', 'scene-0078', 'scene-0943', 'scene-1026', 'scene-1027', 'scene-1028', 'scene-1029',
     'scene-1030', 'scene-1031', 'scene-1032', 'scene-0148', 'scene-1034', 'scene-1035', 'scene-1036', 'scene-1037',
     'scene-1038', 'scene-1039', 'scene-1040', 'scene-1041', 'scene-1042', 'scene-1043',
     'scene-0266', 'scene-0086', 'scene-0087', 'scene-0088', 'scene-0089', 'scene-0090', 'scene-0091', 'scene-0111',]
...
val = \
    ['scene-0003', 'scene-0012', 'scene-1108', 'scene-0014', 'scene-0651', 'scene-0016', 'scene-0400', 'scene-0988',
     'scene-0035', 'scene-0747', 'scene-0038', 'scene-0039', 'scene-0092', 'scene-0093', 'scene-0899', 'scene-0095',
     'scene-1104', 'scene-0097', 'scene-0098', 'scene-0923', 'scene-0100', 'scene-0151', 'scene-0027', 'scene-0103',
     'scene-0104', 'scene-1080', 'scene-0058', 'scene-0107', 'scene-0108', 'scene-1067', 'scene-0850', 'scene-0221']

test = \
    ['scene-0448', 'scene-0942', 'scene-0079', 'scene-0080', 'scene-0081', 'scene-0740', 'scene-0083', 'scene-0398',
     'scene-0225', 'scene-0535', 'scene-0022', 'scene-0115', 'scene-0116', 'scene-0109', 'scene-0118', 'scene-0119',
     'scene-0552', 'scene-0142', 'scene-0240', 'scene-0144', 'scene-0145', 'scene-0146', 'scene-0085', 'scene-0072',
     'scene-0265', 'scene-0919', 'scene-0279', 'scene-0011', 'scene-1033', 'scene-0282', 'scene-0307', 'scene-0705']
