...
[![Website](doc/badges/badge-website.svg)](https://kieran514.github.io/Robust-Depth-Project/)
[![Paper](https://img.shields.io/badge/arXiv-PDF-b31b1b)](https://arxiv.org/abs/2307.08357)
<!-- [![Hugging Face Model](https://img.shields.io/badge/🤗%20Hugging%20Face-Model-green)](https://kieran514.github.io/Robust-Depth-Project/) -->
<!-- [![Website](https://img.shields.io/badge/Project-Website-1081c2)]([https://arxiv.org/abs/2312.02145) -->](https://arxiv.org/abs/2307.08357)) -->
...
#### Cityscape Foggy
First, download leftImg8bit_trainvaltest_foggy.zip from the [CityScape Website](https://www.cityscapes-dataset.com/downloads/) and unzip it in the data directory.

Thankfully, ManyDepth provides the ground truth depth (see [ManyDepth](https://github.com/nianticlabs/manydepth?tab=readme-ov-file) at the bottom of the 'Pretrained weights and evaluation' section of the GitHub page). These need to be extracted into splits\cityscape.
...
#### NuScenes-Night
For this testing, we provide the test dataset itself with the ground truth for simplicity. Additions have been made to the code to allow for these evaluations, so make sure you are up to date. First, download the [NuScenes_test.zip](https://drive.google.com/file/d/1zeZ2pMnsXLn79_qPcO7dgbEbhbZ2-J1z/view?usp=sharing) and extract it to the data path. This dataset is under the same license as defined in the [NuScenes](https://www.nuscenes.org/nuscenes) Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International Public License (“CC BY-NC-SA 4.0”). This is not meant for commercial use, and all credit for the data goes to [NuScenes](https://www.nuscenes.org/nuscenes). An individual license is provided with the zipped data.

Next, download [gt_depths.zip](https://drive.google.com/file/d/1kXsZ7DbcEUO4LueHvv2AqvF8PkWbW6OX/view?usp=sharing) and extract these files into 'splits/nuScenes_test_night/'. Now we can simply run:
```
