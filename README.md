...
#### Cityscape Foggy
First download leftImg8bit_trainvaltest_foggy.zip from the [CityScape Website](https://www.cityscapes-dataset.com/downloads/) and unizp this in the data directory.
